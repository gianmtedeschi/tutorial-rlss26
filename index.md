...
Alternatively, if you prefer to work locally, you can download the notebooks and set up the required environment as:
...
| 📚 Tutorial Module   | 📝 Description                 | 💻 Exercise                                                                                                                                                                                                         | ✅ Solution                                                                                                                                                                                               |
| :------------------ | :---------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
